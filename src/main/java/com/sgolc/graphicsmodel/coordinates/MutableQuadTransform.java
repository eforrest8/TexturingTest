 ...
 */
public class MutableQuadTransform implements CoordinateMapper {

    public final Point[] points = new Point[4];

    public MutableQuadTransform() {
        this(
                new Point(0, 0),
                new Point(1, 0),
                new Point(1, 1),
     ...
     */
    public MutableQuadTransform(Point first, Point second, Point third, Point fourth) {
        this.points[0] = first;
